...
static void enact_RH_CONTROL_RDSP_multiplexado_r1_demora(Microondas* handle);
...
static void enact_RDP_titila_r1_DPoff(Microondas* handle);
static void enact_RDP_titila_r1_DPon(Microondas* handle);
static void enact_RDP_fijo(Microondas* handle);
...
static void exact_RH_CONTROL_RDSP_multiplexado_r1_demora(Microondas* handle);
...
static void exact_RDP_titila_r1_DPoff(Microondas* handle);
static void exact_RDP_titila_r1_DPon(Microondas* handle);
...
static void enseq_RH_CONTROL_RDSP_multiplexado_r1_demora_default(Microondas* handle);
...
static void enseq_RDP_titila_default(Microondas* handle);
static void enseq_RDP_titila_r1_DPoff_default(Microondas* handle);
static void enseq_RDP_titila_r1_DPon_default(Microondas* handle);
static void enseq_RDP_fijo_default(Microondas* handle);
...
static void enseq_RDP_default(Microondas* handle);
static void enseq_RDP_titila_r1_default(Microondas* handle);
...
static void exseq_RH_CONTROL_RDSP_multiplexado_r1_demora(Microondas* handle);
...
static void exseq_RDP_titila(Microondas* handle);
static void exseq_RDP_titila_r1_DPoff(Microondas* handle);
static void exseq_RDP_titila_r1_DPon(Microondas* handle);
static void exseq_RDP_fijo(Microondas* handle);
...
static void exseq_RDP(Microondas* handle);
static void exseq_RDP_titila_r1(Microondas* handle);
...
static void react_RDP_titila_r1__entry_Default(Microondas* handle);
static void react_RDP__entry_Default(Microondas* handle);
...
/*! The reactions of state demora. */
static sc_integer RH_CONTROL_RDSP_multiplexado_r1_demora_react(Microondas* handle, const sc_integer transitioned_before);
...
static sc_integer RDP_titila_react(Microondas* handle, const sc_integer transitioned_before);

/*! The reactions of state DPoff. */
static sc_integer RDP_titila_r1_DPoff_react(Microondas* handle, const sc_integer transitioned_before);

/*! The reactions of state DPon. */
static sc_integer RDP_titila_r1_DPon_react(Microondas* handle, const sc_integer transitioned_before);

/*! The reactions of state fijo. */
static sc_integer RDP_fijo_react(Microondas* handle, const sc_integer transitioned_before);
...
const uint8_t MICROONDAS_MICROONDASINTERNAL_NOTA264 = 3787;
const uint8_t MICROONDAS_MICROONDASINTERNAL_NOTA132 = 7566;
const uint8_t MICROONDAS_MICROONDASINTERNAL_NOTA528 = 1893;
...
sc_boolean microondas_is_state_active(const Microondas* handle, MicroondasStates state)
{
	...
	switch (state)
	{
		...
		case Microondas_RH_CONTROL_RDSP_multiplexado_r1_display_encendido_r1_d1 :
			...
			break;
		case Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora :
			result = (sc_boolean) (handle->stateConfVector[SCVI_MICROONDAS_RH_CONTROL_RDSP_MULTIPLEXADO_R1_DEMORA] == Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora
			);
			break;
		...
		case Microondas_RR_Reloj_detenido :
			...
			break;
		case Microondas_RDP_titila :
			result = (sc_boolean) (handle->stateConfVector[SCVI_MICROONDAS_RDP_TITILA] >= Microondas_RDP_titila
				&& handle->stateConfVector[SCVI_MICROONDAS_RDP_TITILA] <= Microondas_RDP_titila_r1_DPon);
			break;
		case Microondas_RDP_titila_r1_DPoff :
			result = (sc_boolean) (handle->stateConfVector[SCVI_MICROONDAS_RDP_TITILA_R1_DPOFF] == Microondas_RDP_titila_r1_DPoff
			);
			break;
		case Microondas_RDP_titila_r1_DPon :
			result = (sc_boolean) (handle->stateConfVector[SCVI_MICROONDAS_RDP_TITILA_R1_DPON] == Microondas_RDP_titila_r1_DPon
			);
			break;
		case Microondas_RDP_fijo :
			result = (sc_boolean) (handle->stateConfVector[SCVI_MICROONDAS_RDP_FIJO] == Microondas_RDP_fijo
			);
			break;
		default:
			result = bool_false;
...
static void swap_in_events(Microondas* handle)
{
	...
	handle->current.timeEvents.Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_time_event_0_raised = handle->timeEvents.microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_tev0_raised;
	handle->timeEvents.microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_tev0_raised = bool_false;
	...
	handle->current.timeEvents.Microondas_RDP_titila_r1_DPoff_time_event_0_raised = handle->timeEvents.microondas_RDP_titila_r1_DPoff_tev0_raised;
	handle->timeEvents.microondas_RDP_titila_r1_DPoff_tev0_raised = bool_false;
	handle->current.timeEvents.Microondas_RDP_titila_r1_DPon_time_event_0_raised = handle->timeEvents.microondas_RDP_titila_r1_DPon_tev0_raised;
	handle->timeEvents.microondas_RDP_titila_r1_DPon_tev0_raised = bool_false;
}
...
static void swap_internal_events(Microondas* handle)
{
	...
	handle->current.timeEvents.Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_time_event_0_raised = bool_false;
	...
	handle->current.timeEvents.Microondas_RDP_titila_r1_DPoff_time_event_0_raised = bool_false;
	handle->current.timeEvents.Microondas_RDP_titila_r1_DPon_time_event_0_raised = bool_false;
	...
	handle->current.internal.sdpfijo_raised = handle->internal.sdpfijo_raised;
	handle->internal.sdpfijo_raised = bool_false;
	handle->current.internal.sdptitila_raised = handle->internal.sdptitila_raised;
	handle->internal.sdptitila_raised = bool_false;
}
...
static void micro_step(Microondas* handle)
{
	...
	{ 
		switch(handle->stateConfVector[ 1 ])
		{
			...
			case Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora :
			{
				transitioned = RH_CONTROL_RDSP_multiplexado_r1_demora_react(handle, transitioned);
				break;
			}
			default: 
				/* do nothing */
	...
	{ 
		switch(handle->stateConfVector[ 6 ])
		{
			case Microondas_RR_Reloj :
			{
				transitioned = RR_Reloj_react(handle, transitioned);
				break;
			}
			case Microondas_RR_Reloj_detenido :
			{
				transitioned = RR_Reloj_detenido_react(handle, transitioned);
				break;
			}
			default: 
				/* do nothing */
	...
	{ 
		switch(handle->stateConfVector[ 7 ])
		{
			case Microondas_RDP_titila_r1_DPoff :
			{
				RDP_titila_r1_DPoff_react(handle, transitioned);
				break;
			}
			case Microondas_RDP_titila_r1_DPon :
			{
				RDP_titila_r1_DPon_react(handle, transitioned);
				break;
			}
			case Microondas_RDP_fijo :
			{
				RDP_fijo_react(handle, transitioned);
				break;
			}
			default: 
				/* do nothing */
...
static void enact_RH_CONTROL_HORNO_Horono_reposo(Microondas* handle)
{
	...
	handle->internal.sdpfijo_raised = bool_true;
}
...
static void enact_RH_CONTROL_HORNO_Programacion_horno(Microondas* handle)
{
	...
	handle->internal.sdptitila_raised = bool_true;
}
...
{
	/* Entry action for state 'display_encendido'. */
	microondas_displayapagado(handle, 0);
}
...
/* Entry action for state 'demora'. */
static void enact_RH_CONTROL_RDSP_multiplexado_r1_demora(Microondas* handle)
{
	/* Entry action for state 'demora'. */
	microondas_set_timer(handle, (sc_eventid) &(handle->timeEvents.microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_tev0_raised) , 500, bool_false);
}
...
/* Entry action for state 'DPoff'. */
static void enact_RDP_titila_r1_DPoff(Microondas* handle)
{
	/* Entry action for state 'DPoff'. */
	microondas_set_timer(handle, (sc_eventid) &(handle->timeEvents.microondas_RDP_titila_r1_DPoff_tev0_raised) , 500, bool_false);
	handle->internal.vdp = 0;
	microondas_deciamlPoint(handle, handle->internal.vdp);
}

/* Entry action for state 'DPon'. */
static void enact_RDP_titila_r1_DPon(Microondas* handle)
{
	/* Entry action for state 'DPon'. */
	microondas_set_timer(handle, (sc_eventid) &(handle->timeEvents.microondas_RDP_titila_r1_DPon_tev0_raised) , 500, bool_false);
	handle->internal.vdp = 1;
	microondas_deciamlPoint(handle, handle->internal.vdp);
}

/* Entry action for state 'fijo'. */
static void enact_RDP_fijo(Microondas* handle)
{
	/* Entry action for state 'fijo'. */
	handle->internal.vdp = 1;
...
/* Exit action for state 'demora'. */
static void exact_RH_CONTROL_RDSP_multiplexado_r1_demora(Microondas* handle)
{
	/* Exit action for state 'demora'. */
	microondas_unset_timer(handle, (sc_eventid) &(handle->timeEvents.microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_tev0_raised) );		
}
...
/* Exit action for state 'DPoff'. */
static void exact_RDP_titila_r1_DPoff(Microondas* handle)
{
	/* Exit action for state 'DPoff'. */
	microondas_unset_timer(handle, (sc_eventid) &(handle->timeEvents.microondas_RDP_titila_r1_DPoff_tev0_raised) );		
}

/* Exit action for state 'DPon'. */
static void exact_RDP_titila_r1_DPon(Microondas* handle)
{
	/* Exit action for state 'DPon'. */
	microondas_unset_timer(handle, (sc_eventid) &(handle->timeEvents.microondas_RDP_titila_r1_DPon_tev0_raised) );		
}
...
/* 'default' enter sequence for state demora */
static void enseq_RH_CONTROL_RDSP_multiplexado_r1_demora_default(Microondas* handle)
{
	/* 'default' enter sequence for state demora */
	enact_RH_CONTROL_RDSP_multiplexado_r1_demora(handle);
	handle->stateConfVector[1] = Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora;
	handle->stateConfVectorPosition = 1;
}
...
{
	/* 'default' enter sequence for state titila */
	enseq_RDP_titila_r1_default(handle);
}

/* 'default' enter sequence for state DPoff */
static void enseq_RDP_titila_r1_DPoff_default(Microondas* handle)
{
	/* 'default' enter sequence for state DPoff */
	enact_RDP_titila_r1_DPoff(handle);
	handle->stateConfVector[7] = Microondas_RDP_titila_r1_DPoff;
	handle->stateConfVectorPosition = 7;
}

/* 'default' enter sequence for state DPon */
static void enseq_RDP_titila_r1_DPon_default(Microondas* handle)
{
	/* 'default' enter sequence for state DPon */
	enact_RDP_titila_r1_DPon(handle);
	handle->stateConfVector[7] = Microondas_RDP_titila_r1_DPon;
	handle->stateConfVectorPosition = 7;
}

/* 'default' enter sequence for state fijo */
static void enseq_RDP_fijo_default(Microondas* handle)
{
	/* 'default' enter sequence for state fijo */
	enact_RDP_fijo(handle);
	handle->stateConfVector[7] = Microondas_RDP_fijo;
	handle->stateConfVectorPosition = 7;
}
...
/* 'default' enter sequence for region RDP */
static void enseq_RDP_default(Microondas* handle)
{
	/* 'default' enter sequence for region RDP */
	react_RDP__entry_Default(handle);
}
...
{
	/* 'default' enter sequence for region r1 */
	react_RDP_titila_r1__entry_Default(handle);
}
...
/* Default exit sequence for state demora */
static void exseq_RH_CONTROL_RDSP_multiplexado_r1_demora(Microondas* handle)
{
	/* Default exit sequence for state demora */
	handle->stateConfVector[1] = Microondas_last_state;
	handle->stateConfVectorPosition = 1;
	exact_RH_CONTROL_RDSP_multiplexado_r1_demora(handle);
}
...
{
	/* Default exit sequence for state titila */
	exseq_RDP_titila_r1(handle);
}

/* Default exit sequence for state DPoff */
static void exseq_RDP_titila_r1_DPoff(Microondas* handle)
{
	/* Default exit sequence for state DPoff */
	handle->stateConfVector[7] = Microondas_last_state;
	handle->stateConfVectorPosition = 7;
	exact_RDP_titila_r1_DPoff(handle);
}

/* Default exit sequence for state DPon */
static void exseq_RDP_titila_r1_DPon(Microondas* handle)
{
	/* Default exit sequence for state DPon */
	handle->stateConfVector[7] = Microondas_last_state;
	handle->stateConfVectorPosition = 7;
	exact_RDP_titila_r1_DPon(handle);
}

/* Default exit sequence for state fijo */
static void exseq_RDP_fijo(Microondas* handle)
{
	/* Default exit sequence for state fijo */
	handle->stateConfVector[7] = Microondas_last_state;
...
static void exseq_RH(Microondas* handle)
{
	...
	switch(handle->stateConfVector[ 1 ])
	{
		...
		case Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora :
		{
			exseq_RH_CONTROL_RDSP_multiplexado_r1_demora(handle);
			break;
		}
		default: 
			/* do nothing */
...
/* Default exit sequence for region RDP */
static void exseq_RDP(Microondas* handle)
{
	/* Default exit sequence for region RDP */
	/* Handle exit of all possible states (of Microondas.RDP) at position 7... */
	switch(handle->stateConfVector[ 7 ])
	{
		case Microondas_RDP_titila_r1_DPoff :
		{
			exseq_RDP_titila_r1_DPoff(handle);
			break;
		}
		case Microondas_RDP_titila_r1_DPon :
		{
			exseq_RDP_titila_r1_DPon(handle);
			break;
		}
		case Microondas_RDP_fijo :
		{
			exseq_RDP_fijo(handle);
			break;
		}
		default: 
			/* do nothing */
...
{
	/* Default exit sequence for region r1 */
	/* Handle exit of all possible states (of Microondas.RDP.titila.r1) at position 7... */
	switch(handle->stateConfVector[ 7 ])
	{
		case Microondas_RDP_titila_r1_DPoff :
		{
...
{
	/* Default react sequence for initial entry  */
	enseq_RDP_titila_r1_DPon_default(handle);
}
	...
	{ 
		...
		{ 
			...
			{ 
				...
				enseq_RH_CONTROL_RDSP_multiplexado_r1_demora_default(handle);
...
static sc_integer RH_CONTROL_RDSP_multiplexado_r1_demora_react(Microondas* handle, const sc_integer transitioned_before)
{
	...
	{ 
		if ((transitioned_after) < (1))
		{ 
			if (handle->current.timeEvents.Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_time_event_0_raised == bool_true)
			{ 
				exseq_RH_CONTROL_RDSP_multiplexado_r1_demora(handle);
				handle->current.timeEvents.Microondas_RH_CONTROL_RDSP_multiplexado_r1_demora_time_event_0_raised = bool_false;
				enseq_RH_CONTROL_RDSP_multiplexado_r1_display_apagado_default(handle);
...
static sc_integer RH_CONTROL_RDSP_multiplexado_i_presento_reloj_react(Microondas* handle, const sc_integer transitioned_before)
{
	...
	{ 
		...
		{ 
			...
			microondas_display(handle, handle->internal.vd3, handle->internal.vd2, handle->internal.vd1, handle->internal.vd0);
...
static sc_integer RDP_titila_react(Microondas* handle, const sc_integer transitioned_before)
{
	...
	{ 
		...
		{ 
			if (handle->current.internal.sdpfijo_raised == bool_true)
			{ 
				exseq_RDP_titila(handle);
				enseq_RDP_fijo_default(handle);
				react(handle, 0);
...
static sc_integer RDP_titila_r1_DPoff_react(Microondas* handle, const sc_integer transitioned_before)
{
	...
	{ 
		if ((transitioned_after) < (7))
		{ 
			if (handle->current.timeEvents.Microondas_RDP_titila_r1_DPoff_time_event_0_raised == bool_true)
			{ 
				exseq_RDP_titila_r1_DPoff(handle);
				handle->current.timeEvents.Microondas_RDP_titila_r1_DPoff_time_event_0_raised = bool_false;
				enseq_RDP_titila_r1_DPon_default(handle);
				RDP_titila_react(handle, 7);
				transitioned_after = 7;
			} 
		} 
		/* If no transition was taken then execute local reactions */
		if ((transitioned_after) == (transitioned_before))
		{ 
			transitioned_after = RDP_titila_react(handle, transitioned_before);
		} 
	} return transitioned_after;
}
...
static sc_integer RDP_titila_r1_DPon_react(Microondas* handle, const sc_integer transitioned_before)
{
	...
	{ 
		if ((transitioned_after) < (7))
		{ 
			if (handle->current.timeEvents.Microondas_RDP_titila_r1_DPon_time_event_0_raised == bool_true)
			{ 
				exseq_RDP_titila_r1_DPon(handle);
				handle->current.timeEvents.Microondas_RDP_titila_r1_DPon_time_event_0_raised = bool_false;
				enseq_RDP_titila_r1_DPoff_default(handle);
				RDP_titila_react(handle, 7);
				transitioned_after = 7;
			} 
		} 
...
static sc_integer RDP_fijo_react(Microondas* handle, const sc_integer transitioned_before)
{
	...
	{ 
		if ((transitioned_after) < (7))
		{ 
			if (handle->current.internal.sdptitila_raised == bool_true)
			{ 
				exseq_RDP_fijo(handle);
				enseq_RDP_titila_default(handle);
				react(handle, 0);
				transitioned_after = 7;
			} 
		} 
